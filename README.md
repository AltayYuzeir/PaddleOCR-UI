...
Also help wanted to bring the pipeline to PaddleOCR V3 library with improved models.
...
- Great care was taken to purge the memory of any unnecessary objects after each processing step, to allow for PDFs with hundreds or even thousands of pages to be converted.
